...
void player_turn(){
    ...
    if(turn == 'X' && board[row][column] != 'X' && board[row][column] != 'O'){
        ...
        cout<<"Box already filled!"<<endl<<"Please choose another!!"<<endl<<endl;
        player_turn();
    }
    /* Ends */
    display_board();
...
int main()
{
    ...
    if(turn == 'X' && draw == false){
        cout<<endl<<"Congratulations!Player with 'O' has won the game";
    }
    else if(turn == 'O' && draw == false){
        cout<<endl<<"Congratulations!Player with 'X' has won the game";
    }
    else
